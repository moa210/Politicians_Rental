...
user_1 = User.new(email: "TheresaMay-RealOne@gov.uk", full_name: "Theresa May", politician: true, password: "123123", about: "Theresa Mary May is a British politician serving as Prime Minister of the United Kingdom and Leader of the Conservative Party since 2016. She served as Home Secretary from 2010 to 2016.")
...
user_2 = User.new(email: "BrexitBulldog@gov.uk", full_name: "Boris Johnson", politician: true, password: "123123", about: "Alexander Boris de Pfeffel Johnson, better known as Boris Johnson, is a British politician, popular historian, and journalist. He has been the Member of Parliament for Uxbridge and South Ruislip since 2015.")
...
user_3 = User.new(email: "EdyMilliband@gov.uk", full_name: "Ed Milliband", politician: true, password: "123123", about: "Edward Samuel Miliband is a British politician who was Leader of the Labour Party as well as Leader of the Opposition between 2010 and 2015.")
...
user_4 = User.new(email: "ForTheMany@gov.uk", full_name: "Jeremy Corbyn", politician: true, password: "123123", about: "Jeremy Bernard Corbyn is a British politician serving as Leader of the Labour Party and Leader of the Opposition since 2015.")
...
user_5 = User.new(email: "ChakrabatiDontExpel@gov.uk", full_name: "Shami Chakrabarti", politician: true, password: "123123", about: "Sharmishta Chakrabarti, Baroness Chakrabarti, CBE, PC, commonly known as Shami Chakrabarti, is a British Labour Party politician and member of the House of Lords.")
...
user_7 = User.new(email: "JeremyHunt-notDoH@gov.uk", full_name: "Jeremy Hunt", politician: true, password: "123123", about: "Jeremy Richard Streynsham Hunt is a British Conservative Party politician.")
...
####################### First 6 items for display on home page are above
